...
- [`G20`](https://wilkox.org/treemapify/dev/reference/G20.md) :
  Statistics on the G-20 group of major world economies.
- [`draw_key_rrect()`](https://wilkox.org/treemapify/dev/reference/draw_key_rrect.md)
...
- [`geom_treemap_subgroup_text()`](https://wilkox.org/treemapify/dev/reference/geom_treemap_subgroup_text.md)
  [`geom_treemap_subgroup2_text()`](https://wilkox.org/treemapify/dev/reference/geom_treemap_subgroup_text.md)
  [`geom_treemap_subgroup3_text()`](https://wilkox.org/treemapify/dev/reference/geom_treemap_subgroup_text.md)
...
- [`treemapify()`](https://wilkox.org/treemapify/dev/reference/treemapify.md)
  [`treemapify_fixed()`](https://wilkox.org/treemapify/dev/reference/treemapify.md)
