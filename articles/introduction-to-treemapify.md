...
![](introduction-to-treemapify_files/figure-html/basic_treemap-1.png)
...
‘ggfittext’. For example, we can place the text in the centre of the
tile with `place = "centre"`, and expand it to fill as much of the tile
...
![](introduction-to-treemapify_files/figure-html/subgrouped_treemap-1.png)
...
![](introduction-to-treemapify_files/figure-html/many_subgroups-1.png)
