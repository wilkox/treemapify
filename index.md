...
![](reference/figures/README-basic_treemap-1.png)

This plot isn’t very useful without the knowing what country is
represented by each tile.
[`geom_treemap_text()`](https://wilkox.org/treemapify/reference/geom_treemap_text.md)
...
aesthetics you would use in
[`geom_text()`](https://ggplot2.tidyverse.org/reference/geom_text.html),
like `fontface` or `colour`, we can pass additional options specific for
ggfittext. For example, we can place the text in the centre of the tile
with `place = "centre"`, and expand it to fill as much of the tile as
...
![](reference/figures/README-geom_treemap_text-1.png)
...
[`geom_treemap_subgroup_text()`](https://wilkox.org/treemapify/reference/geom_treemap_subgroup_text.md).
[`geom_treemap_subgroup_text()`](https://wilkox.org/treemapify/reference/geom_treemap_subgroup_text.md)
...
![](reference/figures/README-subgrouped_treemap-1.png)

Note that Argentina is not labelled.
[`geom_treemap_text()`](https://wilkox.org/treemapify/reference/geom_treemap_text.md)
...
[`geom_treemap_subgroup2_border()`](https://wilkox.org/treemapify/reference/geom_treemap_subgroup_border.md),
...
[`geom_treemap_subgroup3_border()`](https://wilkox.org/treemapify/reference/geom_treemap_subgroup_border.md)
then
[`geom_treemap_subgroup2_border()`](https://wilkox.org/treemapify/reference/geom_treemap_subgroup_border.md)
then
[`geom_treemap_subgroup_border()`](https://wilkox.org/treemapify/reference/geom_treemap_subgroup_border.md).
...
![](reference/figures/README-multiple_subgrouped_treemap-1.png)
...
![](reference/figures/README-complex_treemap-1.png)
...
![An example of an animated
treemap](reference/figures/animated_treemap.gif)
