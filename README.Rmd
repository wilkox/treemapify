...
Note that the top-rightmost tile, 'South Africa', is not labelled. `geom_treemap_text`
will hide text labels that cannot fit a tile without being shrunk below a
minimum size, by default 4 points. This can be adjusted with the `min.size`
argument.
