...
treemapify provides [ggplot2](https://ggplot2.tidyverse.org) geoms for drawing [treemaps](http://en.wikipedia.org/wiki/Treemap).
...
[`gganimate`](https://github.com/dgrtwo/gganimate) package, it becomes possible
